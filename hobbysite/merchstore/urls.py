...
from .views import ProductCreateView, ProductTypeListView, ProductDetailView, ProductUpdateView, CartView, TransactionListView
...
urlpatterns = [
    ...
    path('transactions', TransactionListView.as_view(), name="merch-transactions"),
]
