...
urlpatterns = [
    ...
    path('article/<int:pk>/upload-image/', ImageGalleryView.as_view(), name='image-upload'),
    path('article/image/<int:pk>/edit/', ImageGalleryUpdateView.as_view(), name='image-update'),
]
